...
import static com.github.ldaniels528.othello.Camera.*;
...
class OthelloBoard {
    ...
    public OthelloBoard(final Othello gameManager) {
        ...
        this.player = OthelloPiece.WHITE_PIECE;
        this.computer = OthelloPiece.BLACK_PIECE;
    ...
    public static OthelloPiece opposite(final OthelloPiece piece) {
        switch (piece) {
            ...
            case BLACK_PIECE:
                return OthelloPiece.WHITE_PIECE;
            default:
                return null;
        }
    }
    ...
    public void handleMouseClicked(final Point point) {
        if (!cpu.isProcessing()) {
            ...
            SoundManager.getInstance().play(SoundKeys.PIECE_MOVED);
